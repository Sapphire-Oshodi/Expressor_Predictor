...
data = pd.read_csv('expresso_processed (1).csv')
df = data.copy()

st.markdown("<h1 style = 'text-align: center; color: #176B87'>EXPRESSOR PREDICTOR MODEL</h1>", unsafe_allow_html = True)
st.markdown("<h4 style = 'text-align: center; top-margin: 0rem; color: #64CCC5'>BUILT BY SAPPHIRE</h1>", unsafe_allow_html = True)
...
st.sidebar.image('pngwing.com-7.png' ,width = 150, use_column_width = True, caption= 'Welcome User')
st.markdown("<br>", unsafe_allow_html = True)
